/*!
 * FilePond 4.18.0
 * Licen'se'd under MIT, https://opensource.org/licenses/MIT/
...
! function (e, t) {
	...
	var t = function (e, t) {
		...
		d = function (e, t, n, r) {
			...
			}), E(s.inner), s.outer.bottom += s.element.marginBottom, s.outer.right += s.element.marginRight, E(s.outer), s
		},
		p = function (e, t) {
					...
					d = n({
						interpolate: function (e, t) {
							if (!f) {
								...
								})(l += c += -(l - s) * r / u, s, c *= i) || t ? (l = s, c = 0, f = !0, d.onupdate(l), d.oncomplete(l)) : d.onupdate(l)
							}
						},
						target: {
							set: function (e) {
		...
		O = function (e, t) {
			var n = t.opacity,
				...
				_ = "",
				T = "";
			(g(f) || g(d)) && (T += "transform-origin: " + (f || 0) + "px " + (d || 0) + "px;"), g(r) && (_ += "perspective(" + r + "px) "), (g(o) || g(i)) && (_ += "translate3d(" + (o || 0) + "px, " + (i || 0) + "px, 0) "), (g(a) || g(u)) && (_ += "scale3d(" + (g(a) ? a : 1) + ", " + (g(u) ? u : 1) + ", 1) "), g(c) && (_ += "rotateZ(" + c + "rad) "), g(s) && (_ += "rotateX(" + s + "rad) "), g(l) && (_ += "rotateY(" + l + "rad) "), _.length && (T += "transform:" + _ + ";"), g(n) && (T += "opacity:" + n + ";", 0 === n && (T += "visibility:hidden;"), n < 1 && (T += "pointer-events:none;")), g(E) && (T += "height:" + E + "px;"), g(p) && (T += "width:" + p + "px;");
		...
		x = function (e) {
			if (F(e)) return e;
			var t = C(e).trim();
			return /MB$/i.test(t) ? (t = t.replace(/MB$i/, "").trim(), 1e3 * q(t) * 1e3) : /KB/i.test(t) ? (t = t.replace(/KB$i/, "").trim(), 1e3 * q(t)) : q(t)
		},
		Y = function (e) {
		...
		X = function (e) {
			return L(e) ? "array" : function (e) {
				return null === e
			}(e) ? "null" : F(e) ? "int" : /^[0-9]+ ?(?:GB|MB|KB)$/gi.test(e) ? "bytes" : function (e) {
		...
		W = {
			array: function (e) {
				...
				return M(e) ? [] : L(e) ? e : C(e).split(t).map(w).filter(function (e) {
					return e.length
				})
			},
			boolean: G,
			...
			serverapi: function (e) {
				return (r = {}).url = U(n = e) ? n : n.url || "", r.timeout = n.timeout ? parseInt(n.timeout, 10) : 0, r.headers = n.headers ? n.headers : {}, t(j, function (e) {
					r[e] = k(e, n[e], j[e], r.timeout, r.headers)
				}), r.remove = n.remove || null, delete r.headers, r;
				var n, r
			},
			object: function (e) {
				try {
	...
	var ce, fe, de = function (e, t) {
		...
		Ae = {
			...
			ignoredFiles: [
				[".ds_store", "thumbs.db", "desktop.ini"], he.ARRAY
			],
			...
			labelIdle: ['Drag & Drop your files or <span class="filepond--label-action">Browse</span>', he.STRING],
			...
			iconRemove: ['<svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg"> <
				...
				fill = "currentColor"
				fill - rule = "nonzero" / > < /svg>',he.STRING],iconProcess:['<svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg"> <
				path d = "M14 10.414v3.585a1 1 0 0 1-2 0v-3.585l-1.293 1.293a1 1 0 0 1-1.414-1.415l3-3a1 1 0 0 1 1.414 0l3 3a1 1 0 0 1-1.414 1.415L14 10.414zM9 18a1 1 0 0 1 0-2h8a1 1 0 0 1 0 2H9z"
				fill = "currentColor"
				fill - rule = "evenodd" / > < /svg>',he.STRING],iconRetry:['<svg width="26" height="26" viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg"> <
		...
		He = function (e, t) {
			...
			return o.lastModifiedDate = new Date, e._relativePath && (o._relativePath = e._relativePath), U(t) || (t = ke()), t && null === r && Ye(t) ? o.name = t : (r = r || function (e) {
		...
		tt = function (e, t, n) {
			...
			}, a.open(n.method, t, !0), F(n.timeout) && (a.timeout = n.timeout), Object.keys(n.headers).forEach(function (e) {
					...
					if (!T.aborted)
						if (t = t || f.find(P)) {
							...
							c.onload = function () {
								...
								t.status = ct, t.request = null, t.error = o(e.response) || e.statusText, L(t) || a(nt("error", e.status, o(e.response) || e.statusText, e.getAllResponseHeaders()))
			...
			return "function" == typeof t ? function () {
				...
				return function (o, i, a, u, s, l, c) {
					if (o) {
						...
						}, v.ontimeout = rt(u), v.onprogress = s, v.onabort = l, v
					}
				}
			}(e, t, n, r) : null
		},
				...
				f = Object.assign({
					...
					load: function (t, n, r) {
						i.source = t, f.fireSync("init"), i.file ? f.fireSync("load-skip") : (i.file = function (e) {
							...
							return e instanceof Blob || Fe(e) ? t[0] = e.name || ke() : Fe(e) ? (t[1] = e.length, t[2] = We(e)) : U(e) && (t[0] = xe(e), t[1] = 0, t[2] = "application/octet-stream"), {
								name: t[0],
								size: t[1],
								type: t[2]
							}
		...
		Pt = function (e, n, r) {
			return {
				...
				DID_SET_FILES: function (t) {
					...
					}), i = Le(r.items), o.forEach(function (t, n) {
						i.find(function (e) {
				...
				DID_UPDATE_ITEM_METADATA: function (t) {
					var o = t.id;
					clearTimeout(r.itemUpdateTimeout), r.itemUpdateTimeout = setTimeout(function () {
						var t = gt(r.items, o);
						if (n("IS_ASYNC")) {
							var i, a = function () {
								setTimeout(function () {
							...
							return t.status === Ie.PROCESSING_COMPLETE ? (i = r.options.instantUpload, void t.revert(Et(r.options.server.url, r.options.server.revert), n("GET_FORCE_REVERT")).then(i ? a : function () {}).catch(function () {})) : t.status === Ie.PROCESSING ? function (e) {
								t.abortProcessing().then(e ? a : function () {})
							}(r.options.instantUpload) : void(r.options.instantUpload && a())
						}
						Oe("SHOULD_PREPARE_OUTPUT", !1, {
							item: t,
							query: n
						}).then(function (n) {
							n && e("REQUEST_PREPARE_OUTPUT", {
								query: o,
								item: t,
								success: function (t) {
				...
				SORT: function (t) {
					var o = t.compare;
					St(r, o), e("DID_SORT_ITEMS", {
						items: n("GET_ACTIVE_ITEMS")
					})
				},
					...
					if (M(o)) f({
						...
						if (! function (e) {
							...
							if (_.status === Ie.PROCESSING_COMPLETE || _.status === Ie.PROCESSING_REVERT_ERROR) {
								...
								if (_.revert(Et(r.options.server.url, r.options.server.revert), T).then(function () {
										T && e("ADD_ITEM", {
											source: o,
											index: a,
											interactionMethod: u,
						...
						v.on("init", function () {
							...
							var t = function (t) {
								t ? (v.on("metadata-update", function (t) {
							...
							e("DID_THROW_ITEM_PROCESSING_REVERT_ERROR", {
								...
								error: t,
								status: {
									main: Ot(r.options.labelFileProcessingRevertError)(t),
									sub: r.options.labelTapToRetry
								}
							})
						...
						var h = r.options.server || {},
							...
							y = h.restore,
							D = h.fetch;
						v.load(o, Je(I === ve.INPUT ? U(o) && function (e) {
							return (e.indexOf(":") > -1 || e.indexOf("//") > -1) && Rt(location.href) !== Rt(e)
						}(o) && D ? at(R, D) : ht : at(R, I === ve.LIMBO ? y : O)), function (e, t, r) {
							Oe("LOAD_FILE", e, {
								query: n
							}).then(t).catch(r)
						})
				...
				COMPLETE_LOAD_ITEM: function (t) {
					...
					if (Y(s) && u && St(r, s), e("DID_LOAD_ITEM", {
							id: o.id,
							error: null,
						...
						id: o.id,
						value: u
					})) : void(n("IS_ASYNC") && r.options.instantUpload && e("REQUEST_ITEM_PROCESSING", {
						query: o.id
					}));
				...
				REQUEST_ITEM_PROCESSING: At(r, function (t, o, i) {
					if (t.status === Ie.IDLE || t.status === Ie.PROCESSING_ERROR) t.status !== Ie.PROCESSING_QUEUED && (t.requestProcessing(), e("DID_REQUEST_ITEM_PROCESSING", {
						id: t.id
					}), e("PROCESS_ITEM", {
						query: t,
						success: o,
				...
				PROCESS_ITEM: At(r, function (t, o, i) {
					...
					if (n("GET_ITEMS_BY_STATUS", Ie.PROCESSING).length !== a) {
						if (t.status !== Ie.PROCESSING) {
							...
							var s = r.options;
							t.process(Tt(pt(s.server.url, s.server.process, s.name, {
				...
				REMOVE_ITEM: At(r, function (t, o, i, a) {
					var u = function () {
							var n = t.id;
							gt(r.items, n).archive(), e("DID_REMOVE_ITEM", {
								error: null,
								id: n,
								item: t
							}), yt(e, r), o(Te(t))
						...
						s = r.options.server;
					t.origin === ve.LOCAL && s && Y(s.remove) ? (e("DID_START_ITEM_REMOVE", {
						id: t.id
					}), s.remove(t.source, function () {
						return u()
					}, function (n) {
				...
				REVERT_ITEM_PROCESSING: At(r, function (t) {
					t.revert(Et(r.options.server.url, r.options.server.revert), n("GET_FORCE_REVERT")).then(function () {
						(r.options.instantUpload || function (e) {
							return !vt(e.file)
						}(t)) && e("REMOVE_ITEM", {
							query: t.id
						})
		...
		Ut = function (e) {
			var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : ".";
			return (e = Math.round(Math.abs(e))) < 1e3 ? e + " bytes" : e < qt ? Math.floor(e / Bt) + " KB" : e < Vt ? Ft(e / qt, 1, t) + " MB" : Ft(e / Vt, 2, t) + " GB"
		},
		Bt = 1e3,
		qt = 1e6,
		Vt = 1e9,
		...
		xt = function (e) {
			var t = e.root,
				n = e.props;
			Mt(t.ref.fileSize, Ut(t.query("GET_ITEM_SIZE", n.id))), Mt(t.ref.fileName, bt(t.query("GET_ITEM_NAME", n.id)))
		},
		Yt = function (e) {
			var t = e.root,
				n = e.props;
		...
		jt = S({
			...
			create: function (e) {
				...
				var i = Lt("span");
				i.className = "filepond--file-info-sub", t.appendChild(i), t.ref.fileSize = i, Mt(i, t.query("GET_LABEL_FILE_WAITING_FOR_SIZE")), Mt(o, bt(t.query("GET_ITEM_NAME", n.id)))
			},
			mixins: {
	...
	var Zt, Kt = function (e) {
		...
		cn = S({
			create: function (e) {
				...
				if (u && i && (Qt.RevertItemProcessing.label = "GET_LABEL_BUTTON_REMOVE_ITEM", Qt.RevertItemProcessing.icon = "GET_ICON_REMOVE"), s && !i) {
					var f = un.DID_COMPLETE_ITEM_PROCESSING;
					f.info.translateX = tn, f.info.translateY = en, f.status.translateY = en, f.processingCompleteIndicator = {
						opacity: 1,
						scaleX: 1,
						scaleY: 1
					}
				}
				if (s && !a && (["DID_START_ITEM_PROCESSING", "DID_REQUEST_ITEM_PROCESSING", "DID_UPDATE_ITEM_PROCESS_PROGRESS", "DID_THROW_ITEM_PROCESSING_ERROR"].forEach(function (e) {
						un[e].status.translateY = en
					}), un.DID_THROW_ITEM_PROCESSING_ERROR.status.translateX = Jt), l && i) {
					Qt.RevertItemProcessing.align = "BUTTON_REMOVE_ITEM_POSITION";
					var d = un.DID_COMPLETE_ITEM_PROCESSING;
					d.info.translateX = Kt, d.status.translateY = en, d.processingCompleteIndicator = {
						opacity: 1,
						scaleX: 1,
						scaleY: 1
					}
				...
				t(Qt, function (e, t) {
					...
					c.includes(e) && r.appendChildView(n), n.element.dataset.align = r.query("GET_STYLE_" + t.align), n.element.classList.add(t.className), n.on("click", function (e) {
						e.stopPropagation(), r.dispatch(t.action, {
							query: o
						})
					}), r.ref["button" + e] = n
				}), r.ref.processingCompleteIndicator = r.appendChildView(r.createChildView(sn)), r.ref.processingCompleteIndicator.element.dataset.align = r.query("GET_STYLE_BUTTON_PROCESS_ITEM_POSITION"), r.ref.info = r.appendChildView(r.createChildView(jt, {
					id: o
				})), r.ref.status = r.appendChildView(r.createChildView(zt, {
					id: o
				}));
				var p = r.appendChildView(r.createChildView(Nt, {
					opacity: 0,
					align: r.query("GET_STYLE_LOAD_INDICATOR_POSITION")
				}));
				p.element.classList.add("filepond--load-indicator"), r.ref.loadProgressIndicator = p;
				var E = r.appendChildView(r.createChildView(Nt, {
					opacity: 0,
					align: r.query("GET_STYLE_PROGRESS_INDICATOR_POSITION")
				}));
				E.element.classList.add("filepond--process-indicator"), r.ref.processProgressIndicator = E, r.ref.activeStyles = []
			},
			write: function (e) {
				var n = e.root,
					r = e.actions,
		...
		fn = S({
			create: function (e) {
				var t = e.root,
					n = e.props;
				t.ref.fileName = Lt("legend"), t.appendChild(t.ref.fileName), t.ref.file = t.appendChildView(t.createChildView(cn, {
					id: n.id
				})), t.ref.data = !1
			},
			ignoreRect: !0,
			...
			create: function (e) {
				...
				t.ref.handleClick = function (e) {
					...
					if (e.isPrimary) {
						...
						var a, u, s, l = (a = t.query("GET_ACTIVE_ITEMS"), u = a.map(function (e) {
							return e.id
						}), s = void 0, {
							setIndex: function (e) {
								s = e
		...
		Rn = function (e, t, n) {
			...
			e.dragOffset ? (e.translateX = null, e.translateY = null, e.translateX = e.dragOrigin.x + e.dragOffset.x, e.translateY = e.dragOrigin.y + e.dragOffset.y, e.scaleX = 1.025, e.scaleY = 1.025) : (e.translateX = t, e.translateY = n, Date.now() > e.spawnDate && (0 === e.opacity && On(e, t, n, r, o), e.scaleX = 1, e.scaleY = 1, e.opacity = 1))
		},
		...
		Dn = A({
			DID_ADD_ITEM: function (e) {
				...
				t.ref.lastItemSpanwDate = u, t.appendChildView(t.createChildView(mn, {
					spawnDate: u,
					id: r,
					opacity: s,
					interactionMethod: i
				...
				if (a) {
					...
					var T = {
							...
							getGridIndex: function () {
								return f > hn.getHeight || f < 0 || c > hn.getWidth || c < 0 ? s : this.y * E + this.x
							},
							getColIndex: function () {
								for (var e = t.query("GET_ACTIVE_ITEMS"), n = t.childViews.filter(function (e) {
										...
										return e === a
									}), i = yn(a), u = r.length, s = u, l = 0, c = 0, d = 0, p = 0; p < u; p++)
				...
				if (0 !== s.length) {
					...
					if (1 === m) {
						...
						s.forEach(function (e, t) {
							...
							o && (e.translateX = null, e.translateY = null), e.markedForRemoval || Rn(e, 0, g + h);
						...
						s.forEach(function (e, t) {
							...
							var n = t + p + f + d,
								...
								s = Math.sign(a - R),
								E = Math.sign(u - O);
							R = a, O = u, e.markedForRemoval || (o && (e.translateX = null, e.translateY = null), Rn(e, a, u, s, E))
						})
					}
				}
			},
		...
		Pn = S({
			create: function (e) {
				var t = e.root,
					n = e.props;
				t.ref.list = t.appendChildView(t.createChildView(Sn)), n.dragCoordinates = null, n.overflowing = !1
			},
			write: function (e) {
				var t = e.root,
					n = e.props,
		...
		Ln = function (e) {
			var t = e.root,
				n = e.action;
			t.query("GET_ALLOW_SYNC_ACCEPT_ATTRIBUTE") && bn(t.element, "accept", !!n.value, n.value ? n.value.join(",") : "")
		},
		Mn = function (e) {
			var t = e.root,
				n = e.action;
		...
		Nn = function (e) {
			var t = e.root;
			e.action.value ? 0 === t.query("GET_TOTAL_ITEMS") && bn(t.element, "required", !0) : bn(t.element, "required", !1)
		},
		Gn = function (e) {
			var t = e.root,
				n = e.action;
			bn(t.element, "capture", !!n.value, !0 === n.value ? "" : n.value)
		},
		Un = function (e) {
			var t = e.root,
				n = t.element;
			t.query("GET_TOTAL_ITEMS") > 0 ? (bn(n, "required", !1), bn(n, "name", !1)) : (bn(n, "name", !0, t.query("GET_NAME")), t.query("GET_CHECK_VALIDITY") && n.setCustomValidity(""), t.query("GET_REQUIRED") && bn(n, "required", !0))
		},
		Bn = S({
			tag: "input",
			name: "browser",
			...
			create: function (e) {
				var t = e.root,
					n = e.props;
				t.element.id = "filepond--browser-" + n.id, r(t.element, "name", t.query("GET_NAME")), r(t.element, "aria-controls", "filepond--assistant-" + n.id), r(t.element, "aria-labelledby", "filepond--drop-label-" + n.id), Ln({
					root: t,
					action: {
		...
		xn = S({
			...
			create: function (e) {
				...
				}, o.addEventListener("keydown", t.ref.handleKeyDown), t.element.addEventListener("click", t.ref.handleClick), Fn(o, n.caption), t.appendChild(o), t.ref.label = o
			},
			destroy: function (e) {
				var t = e.root;
		...
		jn = A({
			DID_DRAG: function (e) {
				...
				t.ref.blob ? (t.ref.blob.translateX = n.position.scopeLeft, t.ref.blob.translateY = n.position.scopeTop, t.ref.blob.scaleX = 1, t.ref.blob.scaleY = 1, t.ref.blob.opacity = 1) : function (e) {
					...
					t.ref.blob = t.appendChildView(t.createChildView(Yn, {
						opacity: 0,
						scaleX: 2.5,
						scaleY: 2.5,
						translateX: n,
		...
		zn = A({
			...
			DID_ADD_ITEM: function (e) {
				var t = e.root,
					n = e.action,
					r = Lt("input");
				r.type = "hidden", r.name = t.query("GET_NAME"), r.disabled = t.query("GET_DISABLED"), t.ref.fields[n.id] = r, Xn(t)
			},
			DID_LOAD_ITEM: function (e) {
				var t = e.root,
					n = e.action,
			...
			DID_DEFINE_VALUE: function (e) {
				var t = e.root,
					n = e.action,
					r = Hn(t, n.id);
				r && (null === n.value ? r.removeAttribute("value") : r.value = n.value, Xn(t))
			},
		...
		Jn = function () {
			var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
			return e = e.toLowerCase(), $n.includes(e) ? "image/" + ("jpg" === e ? "jpeg" : "svg" === e ? "svg+xml" : e) : Zn.includes(e) ? "text/" + e : Kn[e] || ""
		},
		er = function (e) {
		...
		ar = function (e) {
			...
			var t = e.lastModifiedDate,
				n = e.name;
			return (e = e.slice(0, e.size, Jn(Ye(e.name)))).name = n, e.lastModifiedDate = t, e
		},
		ur = function (e) {
		...
		Tr = function (e) {
			...
			var i = {
				...
				addListener: function (a) {
					return n.push(a),
						function () {
							n.splice(n.indexOf(a), 1), 0 === n.length && (pr.splice(pr.indexOf(i), 1), t(r, function (t) {
		...
		gr = function (e, t) {
			return function (e) {
				e.preventDefault(), vr = e.target, t.forEach(function (t) {
					var n = t.element,
						r = t.onenter;
			...
			return function (e) {
				...
				er(n).then(function (r) {
					...
					t.some(function (t) {
						...
						if (f)
							if (Ir(e, a)) {
								if (o = !0, null === t.state) return t.state = "enter", void u(Er(e));
								if (t.state = "over", i && !f) return void mr(n, "none");
								l(Er(e))
							} else i && !o && mr(n, "none"), t.state && (t.state = null, s(Er(e)));
						else mr(n, "none")
					})
				})
			}
				...
				er(n).then(function (n) {
					t.forEach(function (t) {
						var r = t.filterElement,
							...
							a = t.onexit,
							u = t.allowdrop;
						if (t.state = null, !r || Ir(e, o)) return u(n) ? void i(Er(e), n) : a(Er(e))
					})
				})
			}
		},
		Or = function (e, t) {
			return function (e) {
				vr === e.target && t.forEach(function (t) {
					var n = t.onexit;
					t.state = null, n(Er(e))
				})
			}
		...
		Ar = function (e) {
			er(e.clipboardData).then(function (e) {
				e.length && Sr.forEach(function (t) {
					return t(e)
				})
			})
		},
		Pr = function () {
			var e = function (e) {
				...
				t = {
					destroy: function () {
						var t;
						t = e, de(Sr, Sr.indexOf(t)), 0 === Sr.length && (document.removeEventListener("paste", Ar), Dr = !1)
					},
					onload: function () {}
				};
			return function (e) {
				Sr.includes(e) || (Sr.push(e), Dr || (Dr = !0, document.addEventListener("paste", Ar)))
			}(e), t
		},
		br = null,
		Lr = null,
		...
		Cr = function (e, t, n) {
			...
			wr(e, n + " " + t + ", " + r + " " + (1 === r ? e.query("GET_LABEL_FILE_COUNT_SINGULAR") : e.query("GET_LABEL_FILE_COUNT_PLURAL"))), clearTimeout(Lr), Lr = setTimeout(function () {
				! function (e) {
			...
			write: A({
				DID_LOAD_ITEM: function (e) {
					...
					if (Nr(t)) {
						...
						Mr.push(r.filename), clearTimeout(br), br = setTimeout(function () {
							Cr(t, Mr.join(", "), t.query("GET_LABEL_FILE_ADDED")), Mr.length = 0
						}, 750)
					}
				},
				DID_REMOVE_ITEM: function (e) {
		...
		kr = function (e, t) {
			var n = e.query("GET_ALLOW_REPLACE"),
				...
				a = t.length;
			return !r && a > 1 || !!(F(i = r ? i : n ? i : 1) && o + a > i) && (e.dispatch("DID_THROW_MAX_FILES", {
				source: t,
		...
		Xr = function (e) {
			...
			if (r && !e.ref.hopper) {
				...
				}, e.ref.hopper = o, e.ref.drip = e.appendChildView(e.createChildView(kn))
		...
		Wr = function (e, t) {
			var n = e.query("GET_ALLOW_BROWSE"),
				...
				o = n && !r;
			o && !e.ref.browser ? e.ref.browser = e.appendChildView(e.createChildView(Bn, Object.assign({}, t, {
				onload: function (t) {
					if (kr(e, t)) return !1;
					e.dispatch("ADD_ITEMS", {
						items: t,
		...
		Qr = A({
			...
			DID_SET_DISABLED: function (e) {
				var t = e.root,
					n = e.props;
				Xr(t), zr(t), Wr(t, n), t.query("GET_DISABLED") ? t.element.dataset.disabled = "disabled" : t.element.removeAttribute("data-disabled")
			}
		}),
		$r = S({
			name: "root",
			...
			create: function (e) {
				...
				}), t.ref.label = t.appendChildView(t.createChildView(xn, Object.assign({}, n, {
					translateY: null,
					caption: t.query("GET_LABEL_IDLE")
				}))), t.ref.list = t.appendChildView(t.createChildView(Pn, {
					translateY: null
				})), t.ref.panel = t.appendChildView(t.createChildView(En, {
					name: "panel-root"
				})), t.ref.assistant = t.appendChildView(t.createChildView(Br, Object.assign({}, n))), t.ref.data = t.appendChildView(t.createChildView(Qn, Object.assign({}, n))), t.ref.measure = Lt("div"), t.ref.measure.style.height = "100%", t.element.appendChild(t.ref.measure), t.ref.bounds = null, t.query("GET_STYLES").filter(function (e) {
					return !M(e.value)
				}).map(function (e) {
					var n = e.name,
						r = e.value;
					t.element.dataset[n] = r
				}), t.ref.widthPrevious = null, t.ref.widthUpdated = Vr(function () {
				...
				t.query("GET_ALLOW_REORDER") && a && !i && (t.element.addEventListener("touchmove", Fr, {
					passive: !1
			...
			write: function (e) {
				...
				if (Qr({
					...
					var o = t.ref.bounds;
					o || (o = t.ref.bounds = jr(t), t.element.removeChild(t.ref.measure), t.ref.measure = null);
					var i = t.ref,
						a = i.hopper,
						u = i.label,
						s = i.list,
					...
					if (s.translateY = Math.max(0, m - s.rect.element.marginTop) - T.top, c) {
						...
						if (S.push(y), S.length > 4)
							for (var A = S.length, P = A - 10, b = 0, L = A; L >= P; L--)
			...
			destroy: function (e) {
				var t = e.root;
				t.ref.paster && t.ref.paster.destroy(), t.ref.hopper && t.ref.hopper.destroy(), t.element.removeEventListener("touchmove", Fr), t.element.removeEventListener("gesturestart", Fr)
			},
			mixins: {
				styles: ["height"]
			}
			...
			var p = $r(i, {
				...
				I = {
					...
					_write: function (e) {
						...
						E && !n.length || (h(n), E = p._write(e, n, l), (t = i.query("GET_ITEMS")).forEach(function (e, n) {
							e.released && de(t, n)
				...
				h = function (e) {
					e.length && e.filter(function (e) {
						...
						(Array.isArray(t) ? t : [t]).forEach(function (t) {
							"DID_INIT_ITEM" === e.type ? g(t(e.data)) : setTimeout(function () {
								g(t(e.data))
							}, 0)
						})
					})
		...
		Jr = function (e) {
			...
			var i = o.filter(function (e) {
				...
				var o, i = r(e, n.name);
				return t[(o = n.name, qr(o.replace(/^data-/, "")))] = i === n.name || i, t
			}, {});
		...
		eo = function () {
			return (arguments.length <= 0 ? void 0 : arguments[0]) instanceof HTMLElement ? function (e) {
				...
				var r = Object.assign({}, t),
					o = Jr("FIELDSET" === e.nodeName ? e.querySelector("input[type=file]") : e, n);
			...
			}.apply(void 0, arguments) : Kr.apply(void 0, arguments)
		},
		...
		co = (Zt = c() && !("[object OperaMini]" === Object.prototype.toString.call(window.operamini)) && "visibilityState" in document && "Promise" in window && "slice" in Blob.prototype && "URL" in window && "createObjectURL" in window.URL && "performance" in window, function () {
			return Zt
		}),
		fo = {
			apps: []
		...
		po = function () {};
	if (e.Status = {}, e.FileStatus = {}, e.FileOrigin = {}, e.OptionTypes = {}, e.create = po, e.destroy = po, e.parse = po, e.find = po, e.registerPlugin = po, e.getOptions = po, e.setOptions = po, co()) {
		! function (e, t) {
		...
		"loading" !== document.readyState ? setTimeout(function () {
			return Eo()
		}, 0) : document.addEventListener("DOMContentLoaded", Eo);
		var _o = function () {
			return t(Se(), function (t, n) {
				e.OptionTypes[t] = n[1]
			})
		};
		e.Status = Object.assign({}, Me), e.FileOrigin = Object.assign({}, ve), e.FileStatus = Object.assign({}, Ie), e.OptionTypes = {}, _o(), e.create = function () {
			...
			return H(n) && (fo.apps.forEach(function (e) {
				e.setOptions(n)
			}), function (e) {
				t(e, function (e, t) {
	...
	e.supported = co, Object.defineProperty(e, "__esModule", {
		value: !0
	})
});